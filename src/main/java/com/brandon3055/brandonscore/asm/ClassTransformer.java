...
public class ClassTransformer implements IClassTransformer {
    ...
    public byte[] transform(String name, String transformedName, byte[] bytes) {
        ...
        //		else if (transformedName.equals("net.minecraft.network.play.server.S1DPacketEntityEffect")) return
        // patchEffectPacket(bytes);
        //		else if (transformedName.equals("net.minecraft.network.play.server.S1EPacketRemoveEntityEffect")) return
        // patchRemoveEffectPacket(bytes);
        //		else if (transformedName.equals("net.minecraft.client.network.NetHandlerPlayClient")) return
        // patchClientNetHandlerClass(bytes);
    ...
    //
    //		for (MethodNode mn : classNode.methods) if (mn.name.equals("setPotionName") || mn.name.equals("func_76390_b"))
    // setPotionName = mn;
    //
    //
    ...
    //			toInsert.add(new MethodInsnNode(INVOKESTATIC, "com/brandon3055/brandonscore/asm/MethodHolder",
    // "addPotionForSorting", "(Lnet/minecraft/potion/Potion;Ljava/lang/String;)V", false));
    //
    ...
    //			if (mn.name.equals("func_82722_b") || mn.name.equals("readCustomPotionEffectFromNBT"))
    //	readCustomPotionEffectFromNBT = mn;
    //			else if (mn.name.equals("func_82719_a") || mn.name.equals("writeCustomPotionEffectToNBT"))
    ...
    //			toInsert.add(new VarInsnNode(ALOAD, 0));
    //			toInsert.add(new MethodInsnNode(INVOKESTATIC, "com/brandon3055/brandonscore/asm/MethodHolder",
    // "readCustomPotionEffectFromNBT", "(Lnet/minecraft/nbt/NBTTagCompound;)Lnet/minecraft/potion/PotionEffect;",
    // false));
    ...
    // "(Lnet/minecraft/potion/PotionEffect;Lnet/minecraft/nbt/NBTTagCompound;)Lnet/minecraft/nbt/NBTTagCompound;",
    // false));
    //			toInsert.add(new InsnNode(ARETURN));
    //
    ...
    //		for (MethodNode mn : classNode.methods) if (mn.name.equals("func_147260_a") ||
    // mn.name.equals("handleEntityEffect")) handleEffect = mn;
    //
    ...
    //					if ((min.owner.equals("net/minecraft/network/play/server/S1DPacketEntityEffect")) &&
    // (min.name.equals("func_149427_e")))
    //					{
    //						min.desc = "()S";
    //					}
    //				}
    ...
    //						if ((min.name.equals("readUnsignedByte")) && ((readPacketData.instructions.get(i + 1) instanceof
    // FieldInsnNode)))
    //						{
    //							FieldInsnNode fin = (FieldInsnNode)readPacketData.instructions.get(i + 1);
    //							if (fin.name.equals("field_149078_b"))
    //							{
    //								MethodInsnNode newMethod = new MethodInsnNode(INVOKEVIRTUAL, "net/minecraft/network/PacketBuffer",
    // "readShort", "()S", false);
    ...
    //							{
    //								MethodInsnNode newMethod = new MethodInsnNode(INVOKEVIRTUAL, "net/minecraft/network/PacketBuffer",
    // "writeShort", "(I)Lio/netty/buffer/ByteBuf;", false);
    ...
    //		for (MethodNode mn : classNode.methods)
    //		{
    //			if ((mn.name.equals("<init>")) && (mn.desc.equals("(ILnet/minecraft/potion/PotionEffect;)V"))) constructor =
    // mn;
