...
// *
// * BlockCollection is an object that acts as a small virtual minecraft world object. It allows you to set and get
// blocks
...
public class BlockCollection {
    ...
    //	 * @param centreAt00 if true pos 0X, 0Z will be at the centre of the collection allowing for negative and
    // positive
    //	 * block coordinates*/
    ...
    //	}
    //
    //	/**setBlock with a dummy int used to make converting world generators that use World#setBlock(x, y, z, block,
    // meta, updateFlag) a little easier*/
    ...
    ////		}
    ////		else LogHelper.error("BlockCollection.setBlock: Attempt to access block position outside collection
    // boundaries! {"+x+", "+y+", "+z+", Size:"+size+", centreAt00:"+centreAt00+"}");
    //	}
    //
    ...
    ////		}
    ////		else {
    ////			LogHelper.error("BlockCollection.getBlock: Attempt to access block position outside collection boundaries!
    // {"+x+", "+y+", "+z+", Size:"+size+", centreAt00:"+centreAt00+"}");
    ...
    ////		}
    ////		else {
    ////			LogHelper.error("BlockCollection.getBlockMetadata: Attempt to access block position outside collection
    // boundaries! {"+x+", "+y+", "+z+", Size:"+size+", centreAt00:"+centreAt00+"}");
    ////			return 0;
    ////		}
    //	}
